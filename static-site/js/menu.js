    ...
    <nav id="main-nav">
      <ul class="nav-list">
        <li class="nav-item ${activePage === 'index' ? 'active' : ''}">
          <a href="${basePath}index.html" class="nav-link">Heim</a>
        </li>
        <li class="nav-item ${activePage === 'stammbaum' ? 'active' : ''}">
          <a href="${basePath}stammbaum.html" class="nav-link">Stammbaum</a>
        </li>
        <li class="nav-item dropdown ${activePage === 'uberuns' || activePage === 'geschichte' || activePage === 'unterschlupf' ? 'active' : ''}">
          <a href="${basePath}uberuns.html" class="nav-link">&Uuml;ber uns <span class="dropdown-arrow"></span></a>
          <ul class="dropdown-menu">
            <li class="dropdown-item ${activePage === 'uberuns' ? 'active' : ''}">
              <a href="${basePath}uberuns.html">&Uuml;ber uns</a>
            </li>
            <li class="dropdown-item ${activePage === 'geschichte' ? 'active' : ''}">
              <a href="${basePath}geschichte.html">Geschichte</a>
            </li>
            <li class="dropdown-item ${activePage === 'unterschlupf' ? 'active' : ''}">
              <a href="${basePath}unterschlupf.html">Unterschlupf</a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown ${activePage === 'festschrift' || activePage === 'sffechsung' ? 'active' : ''}">
          <a href="${basePath}festschrift.html" class="nav-link">Stiftungsfest <span class="dropdown-arrow"></span></a>
          <ul class="dropdown-menu">
            <li class="dropdown-item ${activePage === 'festschrift' ? 'active' : ''}">
              <a href="${basePath}festschrift.html">Festschrift</a>
            </li>
            <li class="dropdown-item ${activePage === 'sffechsung' ? 'active' : ''}">
              <a href="${basePath}sffechsung.html">Fechsungen</a>
            </li>
          </ul>
        </li>
        <li class="nav-item ${activePage === 'sippungsfolge' ? 'active' : ''}">
          <a href="${basePath}sippungsfolge.html" class="nav-link">Sippungsfolge</a>
        </li>
        <li class="nav-item ${activePage === 'sassenschaft' ? 'active' : ''}">
          <a href="${basePath === '../' ? './sassenschaft.html' : './privat/sassenschaft.html'}" class="nav-link">Sassenschaft</a>
        </li>
        <li class="nav-item ${activePage === 'krystallinen' ? 'active' : ''}">
          <a href="${basePath}krystallinen.html" class="nav-link">Krystallinen</a>
        </li>
        <li class="nav-item ${activePage === 'wappen' ? 'active' : ''}">
          <a href="${basePath}wappen.html" class="nav-link">Wappen</a>
        </li>
        <li class="nav-item ${activePage === 'fechsungen' ? 'active' : ''}">
          <a href="${basePath}fechsungen.html" class="nav-link">Fechsungen</a>
        </li>
        <li class="nav-item ${activePage === 'unserestadt' ? 'active' : ''}">
          <a href="${basePath}unserestadt.html" class="nav-link">Unsere Stadt</a>
        </li>
      </ul>
...
// Function to detect current page from filename
function getCurrentPage() {
  ...
  const pageMap = {
    'index.html': 'index',
    'stammbaum.html': 'stammbaum',
    'uberuns.html': 'uberuns',
    'geschichte.html': 'geschichte',
    'unterschlupf.html': 'unterschlupf',
    'festschrift.html': 'festschrift',
    'sffechsung.html': 'sffechsung',
    'sippungsfolge.html': 'sippungsfolge',
    'sassenschaft.html': 'sassenschaft',
    'krystallinen.html': 'krystallinen',
    'wappen.html': 'wappen',
    'fechsungen.html': 'fechsungen',
    'unserestadt.html': 'unserestadt'
  };
